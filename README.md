# genpark-misra-gries-heavy-hitters-stream-skill

[![Agentic Skill](https://img.shields.io/badge/GenPark-Agentic__Skill-blue.svg)](https://github.com/alphaparkinc/genpark-misra-gries-heavy-hitters-stream-skill)
...
> Misra-Gries frequency estimation algorithm identifying top-K frequent elements (heavy hitters) in high-velocity streaming data.
...
flowchart TD
    ...
    B --> C[genpark-misra-gries-heavy-hitters-stream-skill Streaming Kernel]
